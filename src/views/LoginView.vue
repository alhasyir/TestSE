			...
			<div class="flex flex-col min-h-screen">
				...
				<div class="bg-gray-50 rounded-t-3xl pt-6 px-4 mt-4 flex-grow">
					...
					<p class="font-sans text-sm">
						Silahkan masuk untuk mulai mengisi form perolehan suara.
					</p>
					...
					<form id="login" @submit.prevent="onLogin">
						...
						<div class="mb-4 mt-6 relative">
							...
							<a class="text-sm text-red-500"
								>Lupa password? silahkan hubungi admin!</a
							>
						</div>
...
<script setup lang="ts">
	...
	import { FotoKK, GrayEye, RedEye, ElectionBox } from "@/components/icons";
