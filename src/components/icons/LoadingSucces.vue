<template>
  ...
  >
    <rect width="150" height="150" fill="url(#pattern0_4158_1108)" />
    <defs>
      <pattern id="pattern0_4158_1108" patternContentUnits="objectBoundingBox" width="1" height="1">
        <use xlink:href="#image0_4158_1108" transform="scale(0.00666667)" />
      </pattern>
      <image
        id="image0_4158_1108"
        width="150"
